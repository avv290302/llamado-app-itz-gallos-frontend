...
const formSchema = z.object({
    ...
    city: z.string({
        required_error: "El nombre de la ciudad es equerido"
    }),
    country: z.string({
    ...
    deliveryPrice: z.coerce.number({
        ...
        invalid_type_error: "El tiempo de entrega debe ser un numero valido"
    }),
...
export default function ManageRestaurantForm({onSave, isLoading, restaurant }: Props){
    ...
    useEffect(() => {
        ...
        //Cargar los precios y los formateamos a numerico
        //toFixed se utiliza para asignar dos decimales al valor numerico
    ...
    const onSubmit = (formDataJson: RestaurantFormData) => {
      ...
      //Verificamos que exista la imagen para nuevos restaurantes
